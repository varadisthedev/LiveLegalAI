    ...
    <AppLayout>
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm">
          Manage your LegalDoc Advisor account settings, preferences and
          document defaults.
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-[#151822] border border-gray-200 dark:border-[#1F2937] rounded-xl p-6 flex flex-col md:flex-row items-center gap-6 mb-8 shadow-sm dark:shadow-soft">
        <div className="relative">
          <div className="w-24 h-24 rounded-full border-4 border-white dark:border-[#0F111A] overflow-hidden bg-gray-100 dark:bg-gray-800 shadow-sm flex items-center justify-center">
            {avatarUrl ? (
              ...
              <div className="w-full h-full bg-gradient-to-br from-blue-400 to-indigo-600 flex items-center justify-center text-3xl font-bold text-white">
                {initials}
              </div>
            )}
          </div>
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-2 sm:gap-4 text-xs font-medium text-gray-400 dark:text-gray-400">
            <span className="flex items-center gap-1.5 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
        ...
        <div className="w-full md:w-auto mt-4 md:mt-0">
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-white dark:bg-[#1A1D27] border border-gray-200 dark:border-[#2A3143] text-gray-700 dark:text-gray-300 hover:bg-red-50 dark:hover:bg-red-500/10 hover:text-red-600 dark:hover:text-red-400 hover:border-red-200 dark:hover:border-red-500/30 font-semibold px-6 py-2.5 rounded-lg text-sm transition-colors shadow-sm"
            >
              <LogOut size={14} />
              Logout
            </button>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        <div className="xl:col-span-2 space-y-6">
          ...
          <div className="bg-white dark:bg-[#151822] border border-gray-200 dark:border-[#1F2937] rounded-xl p-6 shadow-sm dark:shadow-soft">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div>
                <label className="block text-xs font-bold text-gray-500 dark:text-gray-500 uppercase tracking-widest mb-2">
                  Full Name
                </label>
                <input
                  type="text"
          ...
          <div className="bg-white dark:bg-[#151822] border border-gray-200 dark:border-[#1F2937] rounded-xl p-6 shadow-sm dark:shadow-soft">
            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 rounded-xl bg-gray-50 dark:bg-[#1A1D27] border border-gray-200 dark:border-[#2A3143] hover:border-gray-300 dark:hover:border-gray-700 transition-colors group gap-4 sm:gap-0">
                ...
                <button className="text-indigo-600 dark:text-indigo-500 hover:text-indigo-700 dark:hover:text-indigo-400 text-sm font-semibold transition-colors pl-14 sm:pl-0 sm:pr-2">
                  Manage
                </button>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 rounded-xl bg-gray-50 dark:bg-[#1A1D27] border border-gray-200 dark:border-[#2A3143] hover:border-gray-300 dark:hover:border-gray-700 transition-colors group gap-4 sm:gap-0">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-500">
                      Manage newsletters and alerts
                    </p>
                  </div>
                </div>
                <button className="text-blue-600 dark:text-blue-500 hover:text-blue-700 dark:hover:text-blue-400 text-sm font-semibold transition-colors pl-14 sm:pl-0 sm:pr-2">
                  Edit
                </button>
              </div>
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-blue-600 to-blue-800 dark:from-[#1C36A4] dark:to-blue-800 rounded-xl p-6 shadow-lg border border-blue-500/20 dark:border-blue-600/30">
            ...
            <div>
              ...
              <p className="text-xs text-blue-100 dark:text-blue-200">
                75% of your documents are verified
              </p>
            </div>
          </div>
          ...
          {/* Recent Activity */}
          <div className="bg-white dark:bg-[#151822] border border-gray-200 dark:border-[#1F2937] rounded-xl p-6 shadow-sm dark:shadow-soft">
            <h3 className="text-xs font-bold text-gray-500 dark:text-gray-500 uppercase tracking-widest mb-6">
              Recent Activity
            </h3>
            ...
            <div className="space-y-6 mb-6">
              <div className="relative pl-6">
                ...
                <p className="text-[11px] text-gray-500 dark:text-gray-500 leading-tight mb-1 font-medium">
              ...
              <div className="relative pl-6">
                ...
                <div className="absolute left-1 top-4 w-px h-full bg-gray-200 dark:bg-[#2A3143]" />
                <h4 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-0.5">
                  New Login
                </h4>
                <p className="text-[11px] text-gray-500 dark:text-gray-500 leading-tight mb-1 font-medium">
                  Chrome on MacOS (NY, USA)
                </p>
                <p className="text-[10px] text-gray-400 dark:text-gray-600 font-bold uppercase">
                  5 Hours Ago
                </p>
          ...
          <div className="bg-white dark:bg-[#151822] border border-gray-200 dark:border-[#1F2937] border-dashed rounded-xl p-6 flex flex-col items-center sm:items-start text-center sm:text-left shadow-sm dark:shadow-soft hover:bg-gray-50 dark:hover:bg-[#1A1D27] transition-colors group cursor-pointer">
            ...
            <p className="text-xs text-gray-500 leading-relaxed mb-4">
              Our legal support team is available 24/7 for you.
            </p>
